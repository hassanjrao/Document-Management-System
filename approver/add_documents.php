            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="card">
                            <div class="body">
                                <h2 class="card-inside-title">Add Documentss</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        ?>
                                                ...
                                                $stmt = $conn->prepare("INSERT INTO `documents`( `document`,`department`,`version`,`start_date`,`end_date`) VALUES (:document,:department,:version,:start_date,:end_date)");
